          ...
          <div class="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
            ...
            <div class="md:7/12 lg:w-6/12">
              ...
              <p class="mt-6 text-gray-600">
                At Coachavo, we believe in the transformative power of
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h4 className=" text-gray-800">
                    Welcome to Coachavo - Empowering Your Learning Journey
                  </h4>
                  <p className="mt-2 text-gray-600">
                    At Coachavo, we believe that learning is the key to personal
                    and professional growth. Our passion lies in providing
                    accessible and innovative online training solutions to help
                    individuals and organizations thrive in an ever-changing
                    world.
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="mt-2 text-gray-600">
                    ...
                    towards achieving your goals with Coachavo.
                  </p>
                </div>
              </div>
            </div>
