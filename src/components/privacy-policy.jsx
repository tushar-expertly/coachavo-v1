    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            In the event that Coachavo invites you to complete and submit an
          ...
          <p className="mb-4">
            The purposes for which Coachavo may utilize your personal
          ...
          <p className="mb-4">
            ...
            Coachavo, you may receive telephone calls from us regarding new
